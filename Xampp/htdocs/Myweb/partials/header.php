...
<body>
    ...
    <div class="nav">
        <ul class="list-nav">
            <li class="nav-item">
                <a class="m1" href="/Myweb/index.php">Trang chủ</a>
            </li>
            <li class="nav-item">
                <a class="m1" href="">Hãng xe</a>
            </li>
            <li class="nav-item">
                <a class="m1" href="/Myweb/view/user/thongtincuahang.php"">Thông tin cửa hàng</a>
            </li>
            <li class="nav-item">
                <a class="m1" href="">Thông tin liên hệ</a>
            </li>
    ...
    <div class="container d-flex">
        <div class="p-3">
            ...
            <a href="view/user/login_user.php">Đăng nhập</a></button>
